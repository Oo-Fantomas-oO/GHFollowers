...
//  GHFollowers
//
//  Created by Fantomas on 17.01.2022.
//
...
class GFEmptyStateView: UIView {
    ...
    let messageLabel = GFTitleLabel(textAlignment: .center, fontSize: 28.0)
    ...
    private func configureLogoImageView() {
        ...
        let logoBottomConstrain: CGFloat = DeviceTypes.isiPhoneSE || DeviceTypes.isiPhone8Zoomed ? 80 : 40
        let logoImageViewBottomConstraint = logoImageView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: logoBottomConstrain)
